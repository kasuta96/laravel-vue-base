...
<template>
    <GuestLayout>
        ...
        <div v-if="error" class="mb-4 text-center font-medium text-sm text-red-600">
            {{ error }}
        </div>

        <a class="flex items-center justify-center mb-4" :href="route('login.sso', ['google'])">
            <SecondaryButton>
        ...
        <a class="flex items-center justify-center mb-4" :href="route('login.sso', ['github'])">
            <SecondaryButton>
